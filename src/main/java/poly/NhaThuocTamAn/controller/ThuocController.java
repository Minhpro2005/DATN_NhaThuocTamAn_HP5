...
public class ThuocController {
	 ...
	 @GetMapping
	    public ResponseEntity<List<ThuocDTO>> getAllThuoc() {
	    ...
	    public ResponseEntity<List<ThuocBanChayDTO>> getTop10BanChay() {
	        return ResponseEntity.ok(thuocService.getTop10ThuocBanChay());
	    }
