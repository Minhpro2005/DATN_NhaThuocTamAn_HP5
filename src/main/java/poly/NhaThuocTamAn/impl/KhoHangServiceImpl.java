...
public class KhoHangServiceImpl implements KhoHangService {
    ...
    private KhoHangDTO toDTO(KhoHang k) {
        return KhoHangDTO.builder()
                ...
                .maThuoc(k.getThuoc() != null ? k.getThuoc().getMaThuoc() : null)
                .tenThuoc(k.getThuoc() != null ? k.getThuoc().getTenThuoc() : null)
                .maBienThe(k.getBienTheThuoc() != null ? k.getBienTheThuoc().getMaBienThe() : null)
                .tenBienThe(k.getBienTheThuoc() != null ? k.getBienTheThuoc().getTenBienThe() : null)
